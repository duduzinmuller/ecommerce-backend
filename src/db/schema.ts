...
export const payments = pgTable("payments", {
  ...
  card_last_digits: varchar("card_last_digits", { length: 4 }),
  due_date: timestamp("due_date"),
  installment_count: integer("installment_count"),
  installment_value: decimal("installment_value", { precision: 10, scale: 2 }),
  billing_type: varchar("billing_type", { length: 20 }),
  card_holder_name: varchar("card_holder_name", { length: 100 }),
  card_expiry_month: varchar("card_expiry_month", { length: 2 }),
  card_expiry_year: varchar("card_expiry_year", { length: 4 }),
  pix_qr_code: text("pix_qr_code"),
  pix_key: varchar("pix_key", { length: 100 }),
  pix_expiration_date: timestamp("pix_expiration_date"),
